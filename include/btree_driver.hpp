...
private:
  ...
  int replicator_bind_init(std::vector<std::string> &params);
  int replicator_reset_replisomes();
  int replicator_bind_replisome(std::vector<std::string> &params);
  ...
  int replicator_binary_fission(std::vector<std::string> &params);

  // Loop topology system
  int translocate(std::vector<std::string> &params);
  int load_loops(std::vector<std::string> &params);
  int write_loops(std::vector<std::string> &params);
  int loop_prng_seed(std::vector<std::string> &params);
  ...
  int switch_DNA_bdry_attraction(std::vector<std::string> &params);
  ...
  // simulator create / destroy bonds related to looping
  int simulator_delete_loops(std::vector<std::string> &params);
  int simulator_form_loops(std::vector<std::string> &params);
